<?php
  $hostname = "d6q8diwwdmy5c9k9.cbetxkdyhwsb.us-east-1.rds.amazonaws.com:3306";  $username = "tkkwirphqjda79q1";
  $dbname = "etoesn3fmoerrnfa";
  $password = "ytjjlujani3oskc6";
        
  $con = new mysqli($hostname, $username, $password, $dbname) OR DIE ("{error:1}");
